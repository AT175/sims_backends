...
export class ChaplainController {
  ...
  async createPrayerRequest(@Body() data: any, @Request() req: any) { return this.service.createPrayerRequest(data, req.user.tenantId); }
  ...
  @Post('counselling')
  @Roles('headmaster', 'chaplain', 'system_admin')
  async createCounselling(@Body() data: any, @Request() req: any) { return this.service.createCounselling(data, req.user.tenantId); }
}
